...
<section class="section hero" data-od-id="hero">
  <div class="container hero-center">
    ...
    <p class="lead">
      One concrete-value subhead — what changes for the reader.
    </p>
    <div class="hero-cta">
  ...
  <div class="container stack" style="gap: 56px;">
    ...
    <div class="grid-3">
      <div class="feature card-flat">
        ...
        <p>
          Two-sentence description that names the user value, not the
          technology.
        </p>
      </div>
      <div class="feature card-flat">
  ...
  <div class="container">
    ...
    <div class="grid-3">
      <div class="stat">
        ...
        <p class="stat-label">
          less data moved over the wire vs. naive sync, on real customer
          workloads.
        </p>
      </div>
      <div class="stat">
        ...
        <p class="stat-label">
          paying teams, including 14 of the YC W26 batch.
        </p>
      </div>
      <div class="stat">
...
<section class="section" data-od-id="quote">
  <div class="container" style="max-width: 800px;">
    ...
    <blockquote class="quote">
      Filebase pays for itself in the first month. We were going to hire a
      dedicated DevOps person to babysit our sync — instead we just switched.
    </blockquote>
    ...
    <div>
      <article class="log-row">
        ...
        <div>
          ...
          <p style="margin: 4px 0 0; color: var(--muted); font-size: 14px;">
            A new content-defined chunker that produces 38× fewer post-edit
            changes on Final Cut projects.
          </p>
        </div>
      ...
      <article class="log-row">
        ...
        <div>
          ...
          <p style="margin: 4px 0 0; color: var(--muted); font-size: 14px;">
            Cap how much a single project can pull each month — useful for
            archive folders.
          </p>
        </div>
